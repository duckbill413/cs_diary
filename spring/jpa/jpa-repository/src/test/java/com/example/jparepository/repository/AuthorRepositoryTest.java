...
import com.example.jparepository.domain.BookAndAuthor;
...
class AuthorRepositoryTest {
    ...
    @Transactional
    void manyToManyTest(){
        Book book1 = givenBook("naruto");
        Book book2 = givenBook("one-piece");
        Book book3 = givenBook("lol");
        Book book4 = givenBook("battlefield");
...
//        System.out.println("authors through books : " + bookRepository.findAll().get(2).getAuthors());
